...
public class Tarea {
    ...
    @ManyToOne
    @JoinColumn(foreignKey=@ForeignKey(name="FK_TAREA_PROYECTO"))
    private Proyecto proyecto;
    @ManyToOne
    @JoinColumn(foreignKey=@ForeignKey(name="FK_TAREA_CREADOR"))
    private Colaboracion creador;
    @ManyToOne
    @JoinColumn(foreignKey=@ForeignKey(name="FK_TAREA_ASIGNACION"))
    private Colaboracion asignacion;
    @ManyToOne
    @JoinColumn(name="asignacion_lista",foreignKey=@ForeignKey(name="FK_TAREA_ASIGNACION_LISTA"))
